...
public class UsersApiServiceImpl implements UsersApiService {
    ...
    public Response addIdVClaim(String userId, List<VerificationClaimResponse> verificationClaimResponse) {
        ...
        VerificationClaimResponse idvClaimResponse =
                identityVerificationService.addIdVClaims(userId, verificationClaimResponse);
    ...
    public Response verifyIdentity(String userId, VerificationClaimRequest verificationClaimRequest) {
        ...
        VerificationPostResponse verificationPostResponse =
                identityVerificationService.verifyIdentity(userId, verificationClaimRequest);

...
public class UsersApi  {
    ...
    @ApiOperation(value = "Add identity verification claim.", notes = "This API provides the capability to add verification claim data", response = VerificationClaimResponse.class, responseContainer = "List", authorizations = {
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Get the identity verification claims of a user", notes = "This API provides the capability to retrieve the verification details of a user", response = VerificationGetResponse.class, responseContainer = "List", authorizations = {
        @Authorization(value = "BasicAuth"),
        @Authorization(value = "OAuth2", scopes = {
